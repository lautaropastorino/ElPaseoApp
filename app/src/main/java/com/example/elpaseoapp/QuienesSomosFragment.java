...
public class QuienesSomosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView encontranos = (TextView) view.findViewById(R.id.parrafo_3);
        encontranos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent link = new Intent(Intent.ACTION_VIEW);
                link.setData(Uri.parse("https://www.facebook.com/paseo.unlp/"));
                startActivity(link);
            }
        });
